...
#
cmd4 = on_command('今晚到我房间来', aliases={
                  '今晚来我房间', '今晚找你算账', '今晚找你', '躺好了吗', '躺好了么', '躺好了没', '跟你睡觉', '和你睡觉'}, priority=2)
...
# 能做你女朋友吗
cmd5 = on_keyword(['我单身', '找对象', '谈恋爱'], priority=2)
...
# 哎呀好的啦 小哥哥不要生气了嘛
cmd6 = on_keyword(['生气', '气死', '服了', '醉了', '不高兴',
                  '不开心', '烦', '难受', '无语'], priority=2)
...
# 不要想那么多。想太多不好
cmd8 = on_command('我总是想太多', aliases={
                  '我想多了', '我多想了', '我多虑了', '想那么多干嘛', '不要想那么多', '不要想太多', '别想那么多', '别想太多'}, priority=2)
...
# 忙什么，都不知道找我聊聊天
cmd9 = on_keyword(['好忙', '事情好多', '事好多', '没空', '好多事',
                  '没时间', '太忙', '忙人'], priority=2)
...
# 叫我小仙女
cmd15 = on_command('怎么称呼你呢', aliases={
                   '叫你什么呢', '你叫什么呢', '你叫啥', '你的名字是什么', '你是机器人吗', '你叫什么名字', '你叫什么'}, priority=2)
...
# 你好帅啊
cmd16 = on_command(
    '我帅吗', aliases={'我长得怎么样', '我好看吗', '我怎么样', '我帅不', '颜值代表'}, priority=2)
...
# 我单身啊
cmd17 = on_command('你有男朋友吗', aliases={'你单身吗', '你有对象吗', '你结婚了吗'}, priority=2)
...
# 我的错咯。要不要道个歉？
cmd20 = on_command(
    '都怪你', aliases={'都是你的错', '都怨你', '揍你', '打你', '滚'}, priority=2)
...
# 我平常不喜欢语音的，很少说话.mp3
cmd21 = on_command('你很喜欢发语音吗', aliases={
                   '你怎么总是发语音', '你怎么老是发语音', '你说什么', '你说啥呢'}, priority=2)
...
cmd24 = on_command('你在想什么', aliases={
                   '你想啥呢', '你想谁呢', '你想什么呢', '你在想啥', '你想干啥'}, priority=2)
...
# 油嘴滑舌的
cmd26 = on_command('你真好看', aliases={
                   '你好漂亮', '你真美', '你真漂亮', '你好好看', '你好美', '你最好看', '你最漂亮', '你最美'}, priority=2)
...
# 不要因为我可爱你就欺负我.mp3
cmd28 = on_command(
    '你好可爱', aliases={'你真可爱', '你那么可爱，你家里人知道吗', '可爱', '你怪可爱的', '你挺可爱的'}, priority=2)
...
# 嗯嗯，你对我真好.mp3
cmd30 = on_command('我对你好吗', aliases={
                   '我对你好不好', '我对你怎么样', '我好吗', '你觉得我对你怎么样'}, priority=2)
...
# 哇你好棒棒哦.mp3
cmd31 = on_command('我棒不棒', aliases={
                   '厉害吧', '牛逼吧', '我厉害吗', '我厉害么', '我棒不', '怎么样', '你觉得我怎么样', '觉得我怎么样'}, priority=2)
...
# 我不信.mp3
cmd32 = on_command('我不喜欢你了', aliases={
                   '你不好看', '你信不信', '你不信', '你信吗', '你相信我', '你相信我吗', '你相信吗'}, priority=2)
...
# 其实我也腼腆.mp3
cmd33 = on_command('我有点害羞', aliases={
                   '我有点内向', '我很内向', '我很害羞', '我是一个不善言辞的人', '我是一个害羞的人', '我是一个内向的人', '我好害羞'}, priority=2)
...
# 你再这样我不理你了啊.mp3
cmd34 = on_command('跳个舞', aliases={
                   '来跳个舞', '一起洗澡吗', '一起睡觉吗', '一起洗澡', '一起睡觉', '跟你睡觉', '跟你洗澡', '帮我搓澡'}, priority=2)
...
# 你以后要只对我一个人好.mp3
cmd35 = on_command(
    '我喜欢你', aliases={'我稀饭你', '我爱你', '你爱我吗', '你喜欢我吗'}, priority=2)
...
# 别老色迷迷的好不好.mp3
cmd36 = on_command('欸嘿嘿', aliases={'嘿嘿', '嘿嘿嘿', '嘿嘿嘿嘿', '嘿嘿嘿嘿嘿', '嘿嘿嘿嘿嘿嘿',
                   '嘿嘿嘿嘿嘿嘿嘿', '嘿嘿嘿嘿嘿嘿嘿嘿', '嘿嘿嘿嘿嘿嘿嘿嘿嘿', '嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿'}, priority=2)
...
# 我刚刚刷抖音.mp3
cmd37 = on_command('你刚才在干什么', aliases={'你刚刚在干什么', '你刚刚在干嘛', '你怎么回事', '你咋回事',
                   '你怎么回事？', '你咋回事？', '你在干嘛', '你在干嘛呢', '你在干吗', '你在干吗呢'}, priority=2)
...
# 只有我一个人的呢.mp3
cmd39 = on_command('你一个人在家吗', aliases={
                   '你一个人在家嘛', '你爸妈在家吗', '你家里有人吗', '就你自己吗', '你一个人吗', '你自己吗', '就你一个人吗'}, priority=2)
...
# 没钱吃饭，你请我啊？.mp3
cmd41 = on_command('一起吃饭吗', aliases={
                   '吃饭吗', '吃饭', '吃饭去', '干饭', '干饭了', '干饭人'}, priority=2)
...
# 主人，您在用我吗.mp3
cmd42 = on_command('召唤kaptree', aliases={
                   '出来挨打', '妹妹', '妹子', '小美人'}, priority=2)
...
# 先说好 我不露脸.mp3
cmd43 = on_command('直播吗', aliases={'裸聊吗', '视频吗', '开视频吗', '来视频吗', '裸聊',
                   '视频', '开视频', '来视频', '想吃你下面', '想吃你下的面', '想吃你下的面条'}, priority=2)
...
cmd44 = on_command('别生气了', aliases={
                   '生啥气吗', '就知道生气', '生气干嘛', '生什么气', '你还生气了', '你倒生气了'}, priority=2)
...
cmd46 = on_command(
    '小懒猪', aliases={'你好懒', '你真懒', '你懒的很', '你怎么那么懒', '你太懒了', '你懒到家了'}, priority=2)
...
cmd47 = on_command(
    '宝贝', aliases={'叫爸爸', '宝贝儿', 'baby', 'honey', '亲爱的'}, priority=2)
...
# 不原谅.mp3
cmd48 = on_command('你原谅我了吗', aliases={
                   '原谅我', '能原谅我吗', '不能原谅我吗', '会原谅我吗', '会原谅我的吧'}, priority=2)
...
# 今晚有事,改天吧.mp3
cmd49 = on_command('今晚约吗', aliases={
                   '今晚吃个饭', '今晚一起吃饭', '今晚怎么样', '今晚行吗', '今晚好吗', '今晚？', '今晚吧'}, priority=2)
